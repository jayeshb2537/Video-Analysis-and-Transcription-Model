...
if (isset($_POST['add_admin'])) {
    ...
    mysqli_query($conn, "INSERT INTO admin_users (username, password) VALUES ('$username', '$password')");
...
// Edit Admin - Fetch Existing Data
$edit_id = '';
$edit_username = '';
if (isset($_GET['edit'])) {
    $edit_id = $_GET['edit'];
    $edit_result = mysqli_query($conn, "SELECT * FROM admins WHERE id = $edit_id");
...
if (isset($_POST['update_admin'])) {
    ...
    if ($password) {
        mysqli_query($conn, "UPDATE admins SET username='$username', password='$password' WHERE id=$id");
    } else {
        mysqli_query($conn, "UPDATE admins SET username='$username' WHERE id=$id");
    }
    header("Location: admin_users.php");
    exit();
}
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="admin_users.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                            <a href="admin_users.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?');">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
