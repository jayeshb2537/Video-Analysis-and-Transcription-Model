...
// Fetch total sales per day, month, and year
$dailySales = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total_price) AS total FROM orders WHERE DATE(created_at) = CURDATE()"));
$monthlySales = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total_price) AS total FROM orders WHERE MONTH(created_at) = MONTH(CURDATE()) AND YEAR(created_at) = YEAR(CURDATE())"));
$yearlySales = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total_price) AS total FROM orders WHERE YEAR(created_at) = YEAR(CURDATE())"));

// Fetch sales data for chart
$salesData = mysqli_query($conn, "SELECT DATE(created_at) AS created_at, SUM(total_price) AS total FROM orders GROUP BY DATE(created_at)");
$chartData = [];
while ($row = mysqli_fetch_assoc($salesData)) {
    $chartData[] = ['date' => $row['created_at'], 'total' => $row['total']];
}
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card text-white bg-primary mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">₹<?php echo number_format($dailySales['total'], 2); ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-white bg-success mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">₹<?php echo number_format($monthlySales['total'], 2); ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-white bg-warning mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">₹<?php echo number_format($yearlySales['total'], 2); ?></h5>
                    </div>
                </div>
            </div>
        </div>
...
<script src="assets/vendor/apexcharts/apexcharts.min.js"></script>
  ...
  <script src="assets/js/main.js"></script>
    <script>
        ...
        const dataPoints = salesData.map(data => data.total);
